...
function(e) {
    ...
    var n = {
        ...
        navigation__mobile: function() {
            e(".Talion_fn_mobilemenu .hamburger").on("click",
            function() {
                var n = e(this),
                i = e(".Talion_fn_mobilemenu .mobilemenu");
        ...
        navigation__closer: function() {
            var i = e(".Talion_fn_wrapper"),
            t = e(".Talion_fn_sidebar").find(".nav_trigger");
            e(".Talion_fn_sidebar .nav__button").off().on("click",
            function() {
        ...
        navigation__resize: function() {
            var n = !1,
            i = e(".Talion_fn_sidebar"),
            t = e(".Talion_fn_content"),
            o = e(".shifter_wrapper"),
            s = i.data("max"),
            a = i.data("min"),
            r = e(".Talion_popup .stopper"),
            d = e(".Talion_fn_sidebar .nav__button"),
            l = e(".Talion_fn_sidebar .width_indicator");
            o.on("mousedown",
            function(e) {
                n = !0,
                e.clientX,
        ...
        service__actions: function() {
            e(".Talion_services .service_nav a").off().on("click",
            function() {
                var i = e(this),
                t = parseInt(i.closest("li").find("input").val(), 10),
                o = i.closest(".Talion_services");
                return n.service__open_by_index(o, t),
                !1
            }),
            e(".Talion_services .item").off().on("click",
            function() {
                var i = e(this),
                t = i.closest(".Talion_services"),
                o = parseInt(i.closest("li").find(".old_index").val(), 10);
                return n.service__open_by_index(t, o),
                !1
            }),
            e(".Talion_services .fn__closer").off().on("click",
            function() {
                var i = e(this).closest(".Talion_services");
        ...
        popup__actions: function() {
            e(".Talion_popup .post_nav a").off().on("click",
            function() {
                var i = e(this),
            ...
            e(".Talion_popup .fn__closer").off().on("click",
            function() {
                e(".Talion_popup").removeClass("opened transition-end").attr("data-address", ""),
        ...
        popup__resize: function() {
            var n = e(".Talion_popup,.Talion_popup .stopper");
            if (!n.hasClass("transition-end")) return ! 1;
            var i = e(".Talion_fn_sidebar"),
        ...
        anchor__jump: function() {
            e(".Talion_fn_sidebar .navigation a,.Talion_fn_mobilemenu ul a").off().on("click",
            function() {
                ...
                if ( - 1 !== n.indexOf("#") && e(n).length) {
                    ...
                    o),
                    e(".Talion_fn_mobilemenu .hamburger").removeClass("is-active"),
                    e(".Talion_fn_mobilemenu .mobilemenu").removeClass("opened").slideUp(500),
                    !1
                }
            })
        },
        ...
        img__to_svg: function() {
            e("img.Talion_fn_svg").each(function() {
                var n = e(this),
                i = n.attr("class"),
                t = n.attr("src");
                e.get(t,
